...
<template>
  <footer ref="footerRef" class="footer">
    <div ref="pawsRef" class="paw-decorations">
    ...
    <div class="footer-content">
      <div ref="taglineRef" class="tagline-section">
        <h2 class="tagline">
          Всегда<br/>
          <span class="accent">дарю</span><br/>
          <span class="accent">радость</span>.
        </h2>
      </div>
      
      <div class="footer-info">
        <div class="info-block">
          <h3 class="info-title">Люси</h3>
          <p class="info-text">
            Чёрный Лабрадор Ретривер<br/>
            Родилась 13 декабря 2020<br/>
            Профессиональный дегустатор вкусняшек
          </p>
        </div>
        
        <div class="info-block">
          <h3 class="info-title">Быстрые факты</h3>
          <ul class="facts-list">
            <li>Любимая еда: Всё</li>
            <li>Лучший навык: Быть милой</li>
            <li>Хобби: Профессиональный сон</li>
          </ul>
        </div>
        
        <div class="info-block">
          <h3 class="info-title">Подписывайтесь</h3>
    ...
    <div class="footer-bottom">
      <div class="bottom-content">
        <div class="signature-logo">
          <svg class="paw-logo" viewBox="0 0 100 100" fill="currentColor">
          ...
          <span class="logo-text">Люси</span>
        </div>
        
        <p class="copyright">
          © 2026 Люси Лабрадор. Все виляния хвостом защищены.
        </p>
        
        <p class="made-with">
          Сделано с 🐾 и большим количеством вкусняшек
        </p>
      </div>
    </div>
  </footer>
