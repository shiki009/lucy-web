  ...
  <section ref="sectionRef" class="message-section">
    <div class="message-container">
      <div class="message-header">
        ...
        <span class="message-label">Послание от Люси</span>
      </div>
      
      <blockquote ref="quoteRef" class="message-quote">
        <span class="highlight">Каждый день</span> — это новое приключение. 
        От утренних потягушек до вечерних обнимашек, я верю в то, что нужно 
        <span class="highlight">жить на полную</span> — с виляющим хвостом 
        и открытым сердцем. Жизнь состоит из 
        <span class="highlight">маленьких моментов</span>: вкусная вкусняшка, 
        солнечное местечко и люди, которые тебя любят.
      </blockquote>
      ...
      <div ref="signatureRef" class="signature-area">
        ...
        <span class="signature-date">С 13 декабря 2020 года</span>
      </div>
    </div>
